                  ...
                  children: [
                    ...
                    Container(
                        ...
                        child: ClipRRect(
                          borderRadius: BorderRadius.circular(12),
                          child: Image.memory(
                            adminhomecontroller.imagebytes,
                            fit: BoxFit.cover,
                          ),
                        )),
                    Gap(height: 4.w),
                    adminhomecontroller.val.value == 0
                        ? SizedBox(
                            width: 40.w,
                            height: 12.w,
                            child: ElevatedButton(
                                style: ElevatedButton.styleFrom(
                                  shape: RoundedRectangleBorder(
                                      borderRadius: BorderRadius.circular(12)),
                                  elevation: 0,
                                  surfaceTintColor: bottomnavigationBarColor,
                                  backgroundColor: bottomnavigationBarColor,
                                  foregroundColor: bottomnavigationBarColor,
                                ),
                                onPressed: () {
                                  adminhomecontroller.isAdded.value = false;
