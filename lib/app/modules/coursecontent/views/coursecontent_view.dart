                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        homepageController.role == "admin" ||
                                homepageController.role == "mainadmin"
                            ? SizedBox.shrink()
                            : Text(
                                "Course Reviews",
                                style: TextStyle(
                        ...
                        homepageController.role == "admin" ||
                                homepageController.role == "mainadmin"
                            ? const SizedBox.shrink()
                            : controller.courseRatings?.value.length == 0
                                ? Text(
                                    "No reviews yet",
                                    style: TextStyle(
                                        fontSize: 11.sp,
                                ...
                                : ListView.builder(
                                    ...
                                    shrinkWrap: true,
                                    itemCount:
                                        controller.courseRatings!.value.length,
                                    itemBuilder: (context, index) {
                                      return Column(
                                        children: [
                                          RatingDetails(
                        ...
                        homepageController.role == "admin" ||
                            ...
                            ? GestureDetector(
                                onTap: () {
                                  ...
                                  Get.toNamed(Routes.QUIZ_DETAILS,
                  ...
                  : controller.courses.isOnline == "0"
                      ...
                      : SizedBox(
                          ...
                          child: CustomButton(
                            title: "Add To Cart",
                            onPressed: () {
                              if (homepageController.isbought.value =
                                  homepageController.isCourseInPaidCourses(
                                      controller.courses,
                                      homepageController.paidCourses!)) {
